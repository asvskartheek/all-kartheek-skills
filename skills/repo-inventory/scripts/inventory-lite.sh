...
echo
printf '== CONFIGS ==\n'
find "$ROOT" -maxdepth 3 \( -name 'package.json' -o -name 'pyproject.toml' -o -name 'Cargo.toml' -o -name 'go.mod' -o -name 'docker-compose.yml' -o -name 'docker-compose.yaml' -o -name 'Dockerfile' \) | sort

echo
printf '== ENTRYPOINT CANDIDATES ==\n'
